...
def run():
    ...
    st.markdown('''<h6 style ='text-align: left;color: #8db004;'> Aloevera (Ghritakumari)</h6>''', unsafe_allow_html=True)
    ...
    if img_file is not None:
        st.image(img_file,use_column_width=False, caption="Uploaded Image", width= 500)
